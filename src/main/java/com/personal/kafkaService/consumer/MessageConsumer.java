...
public class MessageConsumer {
     ...
     * @param count       partition中条数
     * @param username    该用户的消息
     */
    public List<Message> receiveLatestMessage(Properties kafkaParams, String topic, Integer count, String username) {
        //该用户的消息列表
        ...
        try {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                if (record.value().toString().startsWith("{\"")) {
